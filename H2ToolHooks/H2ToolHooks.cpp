...
// Defined in LightmapSceneryFix.cpp: the H2 lightmapper scenery/dynamic-object bake fix (object vertex
// decompress). Auto-detects MCC tool_fast vs H2V H2Tool and self-checks; safe no-op on any other binary.
...
bool H2ToolHooks::hook(HookFlags flags)
{
	...
	{
		// Scenery / dynamic-object bake fix (MCC tool_fast OR H2V H2Tool, auto-detected).
