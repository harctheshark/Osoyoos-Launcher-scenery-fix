...
#nullable enable
        public class ProfileSettingsLauncher
        {
            ...
            // Halo 2 MCC only: inject FP64 Plucker/leaf/moment fixes into stock tool_fast to remove the
            // translation-dependent bright Monte-Carlo lightmap splotch on BSP geometry far from origin.
            [JsonPropertyName("h2_lightmap_precision_fix")]
            public bool H2LightmapPrecisionFix { get; set; } = false;
